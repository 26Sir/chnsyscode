...
browser = webdriver.Chrome(r'D:\code\Python\driver\chromedriver.exe')

# browser.get('http://tyyw.gz.jcy/')
browser.get('http://143.176.22.54/')
f = open("C:\\Users\\26Sir\\Desktop\\ywx"
         "t\\generated_text_file.txt")
# cookie_dict = read_list_from_txt("C:\\Users\\pojok\\generated_text_file.txt")
cookie_dict = []
line = f.readline()
while line:
    cookie_dict.append(line)
    line = f.readline()
...
browser.get("http://143.176.22.54/xtmh")
